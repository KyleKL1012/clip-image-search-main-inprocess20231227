...
def get_file_type(image_path):
    ...
    if "PNG" in libmagic_output:
        return "png"
    if "JPEG" or "JPG" in libmagic_output:
        return "jpg"
...
def get_mongo_collection() -> Collection:
    config = get_config()
    mongo_client = pymongo.MongoClient("mongodb+srv://kylelau1012:N62ypYSnAZ6WOqz6@cluster0.5ufeet5.mongodb.net/?retryWrites=true&w=majority")
